    ...
    <header class="header">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="./pokedex.html" class="${e.includes(`pokedex.html`)?`active`:``}"><i class="fa-solid fa-dragon"></i> Pokédex</a></li>
